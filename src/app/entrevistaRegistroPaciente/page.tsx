          ...
          >
            <motion.div className={styles.wrapperGetInfomacion}>
              <p className={styles.tituloInforUser}>
                Proceso de registro de paciente y asignacion de cita
              </p>
              ...
              <motion.div className={styles.wrapperformInfoUser}>
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <fieldset className="mt-9">
                    <legend className="block mb-2 text-sm font-medium text-gray-900 font-bold">
                  ...
                  <fieldset className="mt-9">
                    <legend className="block mb-2 text-sm font-medium text-gray-900 font-bold">
                      ¿El personal está capacitado regularmente en el manejo de
                  ...
                  <fieldset className="mt-9">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <label
                        ...
                        className="block ms-2 text-sm font-medium text-gray-900"
                      >
                        No, las auditorías son poco frecuentes o inexistentes
                      </label>
                    </div>
